    ...
    <div class="container mt-3">
        <form action="{{ route('kasir.order.store') }}" class="card m-auto p-5" method="POST">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name_costumer" name="name_costumer" value="{{ old('name_costumer') }}">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    ...
                    <div id="wrap-medicines">
                        {{-- akan muncul inputan baru jika + Tambah obat di click --}}
                    </div>
                    <br>
...
@push('script')
    ...
    <script>
        ...
        $("#add-select").on("click", function() {
            ...
            let html = `
                <div class="input-group mb-2" id="medicine-${no}">
